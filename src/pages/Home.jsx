...
const Home = () => {
  return <>
    <section className="min-h-screen p-5 flex flex-col justify-end items-start">
      ...
      <p className="mt-3">
        My name is <span className="font-bold">Ryan Large</span>, fullstack web
        developer and cross platform application engineer. I am here to show you
        why I am the best answer.
      </p>
    ...
    <section className="min-h-screen bg-slate-100" id="projects"></section>
